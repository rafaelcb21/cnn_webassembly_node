(module
  ...
  (func $convolve_grayscale_3x3_same
    ...
    (param $k00_gray     i32)  ;; value of kernel by index 00
    (param $k01_gray     i32)  ;; value of kernel by index 01
    (param $k02_gray     i32)  ;; value of kernel by index 02
    (param $k10_gray     i32)  ;; value of kernel by index 10
    (param $k11_gray     i32)  ;; value of kernel by index 11
    (param $k12_gray     i32)  ;; value of kernel by index 12
    (param $k20_gray     i32)  ;; value of kernel by index 20
    (param $k21_gray     i32)  ;; value of kernel by index 21
  ...
  (export "convolve_grayscale_3x3_same" (func $convolve_grayscale_3x3_same))
)
