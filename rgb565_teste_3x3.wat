...
;;
                  ...
                  ;;        local.set $idx_ker
;;
                  ;;        ;; aqui voce insere br_table como no original...
                  ;;        ;; para cada peso...
                  ;;        ;; sum_r += r * peso_r (r=0)
                  ;;        ;; sum_g += g * peso_g
                  ;;        ;; sum_b += b * peso_b
...
;;
                  ...
                  ;;      )
                  ;;    )
                  ;;    ;; Avança KI manualmente, já que você fez padding
                  ;;    local.get $ki
                  ;;    i32.const 1
                  ;;    i32.add
                  ;;    local.set $ki
                  ...
                  (block $break_kj
                    (loop $loop_kj
                      ...
                      (block $maybe_load_pixel
                        ...
                        (if
                          (then
                            ;; fora da imagem real → usar R, G, B = 0
                            i32.const 0
                            local.set $r
                            i32.const 0
                            local.set $g
  ...
  (export "convolve_3x3_rgb565" (func $convolve_3x3_rgb565))
